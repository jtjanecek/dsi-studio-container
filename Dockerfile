...
RUN git clone https://github.com/frankyeh/DSI-Studio.git
RUN cd DSI-Studio && git checkout 4ab34edf4152bab66dd3cb5b38d498ba7d199e99
RUN mv DSI-Studio src
RUN git clone https://github.com/frankyeh/TIPL.git
RUN cd TIPL && git checkout 66146827c41b03d2fb77774524e7e5e1475918f7
